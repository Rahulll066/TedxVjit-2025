...
export default function TeamsPage() {
    ...
    const teams: Record<TeamName, Member[]> = {
        ...
        Sponsorship: [
            ...
            { id: 55, name: "Kavya", title: "Team Member", company: "VJIT", image: "https://ik.imagekit.io/vjlive/TEDx%20VJIT%202025/Core%20Images/TEDimage.JPG?updatedAt=1759593279876", bio: "", description: "", expertise: [], social: { linkedin: "#", instagram: "", twitter: "", website: "" } },
        ],
        Hospitality: [
