...
export default function TeamsPage() {
    ...
    const teams: Record<TeamName, Member[]> = {
        ...
        Design: [
            { id: 40, name: "Siri Dasari", title: "Team Lead", company: "VJIT", image: "/assets/hero-banner.png", bio: "", description: "", expertise: [], social: { linkedin: "#", instagram: "", twitter: "", website: "" } },
            { id: 41, name: "Sana Fatima", title: "Co - Lead", company: "VJIT", image: "/assets/hero-banner.png", bio: "", description: "", expertise: [], social: { linkedin: "#", instagram: "", twitter: "", website: "" } },
        ...
        Sponsorship: [
            ...
            { id: 55, name: "Kavya", title: "Team Member", company: "VJIT", image: "/assets/2.png", bio: "", description: "", expertise: [], social: { linkedin: "#", instagram: "", twitter: "", website: "" } },
        ],
        Hospitality: [
            { id: 60, name: "Parth Asawa", title: "Team Lead", company: "VJIT", image: "/assets/6.png", bio: "", description: "", expertise: [], social: { linkedin: "#", instagram: "", twitter: "", website: "" } },
        ],
        "Content & Curation": [
